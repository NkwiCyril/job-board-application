...
<header class="absolute inset-x-0 top-0 z-50">
  <nav class="flex items-center justify-between px-6 py-3 lg:px-8" aria-label="Global">
    ...
    <div class="{{--hidden--}} items-center justify-center gap-5 lg:flex lg:flex-1 lg:justify-end sm:flex">
      <a href="{{route('pages.create_opportunity')}}" title="Post an opportunity" class=" text-decoration-none text-xl font-semibold leading-6 transition ease-in-out text-customColor hover:text-customColorDark">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10">
          <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 9a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V15a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25V9Z" clip-rule="evenodd" />
        </svg>
      </a>
      <a href="" title="Unpublished" class=" text-decoration-none text-xl font-semibold leading-6 transition ease-in-out text-customColor hover:text-customColorDark">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10">

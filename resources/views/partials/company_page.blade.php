...
<header class="absolute inset-x-0 top-0 z-50 border-bottom bg-slate-50 border-customColorDark">
  <nav class="flex items-center justify-between px-6 py-3 lg:px-8" aria-label="Global">
    ...
    <div class="hidden items-center justify-center gap-5 lg:flex lg:flex-1 lg:justify-end sm:flex">
      ...
      <a href="{{route('pages.create_opportunity')}}" title="Post an opportunity" class="text-decoration-none flex items-center gap-1 text-xl font-semibold leading-6 transition ease-in-out text-gray-900 hover:text-customColor">
      ...
      <a href="{{route('pages.publish_opportunity')}}" title="Unpublished" class=" flex items-center gap-1 text-decoration-none text-xl font-semibold leading-6 transition ease-in-out text-gray-900 hover:text-customColor">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">

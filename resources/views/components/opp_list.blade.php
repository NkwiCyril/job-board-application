<div>
  <div class="flex-1 justify-between items-center">
    <div class="flex items-center justify-center gap-2">
      ...
      <select name="filter" id="filter" class=" w-1/5 text-gray-900 text-sm rounded-lg focus:ring-customColor p-2.5 focus:border-customColor">
  ...
  <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
    ...
    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
      <div class="flex items-end justify-end h-40 w-full bg-cover bg-[url({{$opportunity['image_url']}})]">
        <img src="{{$opportunity['image_url']}}" class=" object-cover w-full" alt="opportunity_image">
      </div>
      <div class="p-3 flex-col justify-between items-stretch">
        <a href="{{route('pages.opportunity', [$name = $opportunity['title']])}}" class=" text-decoration-none no-underline">
